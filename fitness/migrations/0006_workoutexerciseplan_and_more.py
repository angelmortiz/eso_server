# Generated by Django 4.2.6 on 2023-10-21 16:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('fitness', '0005_remove_program_workout_plans_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exercise', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='exercise_workoutexerciseplan_set', to='fitness.exercise')),
                ('superset_exercise', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='superset_workoutexerciseplan_set', to='fitness.exercise')),
